...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 225.0, 30.0, 120.0, 20.0 ],
					"text" : "p_thru~",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 225.0, 60.0, 120.0, 74.0 ],
					"text" : "a leaf\n\nEnd of the chain, return the result of the stereo signal"
				}
